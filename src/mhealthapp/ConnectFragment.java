...
import mhealthapp.Device.State;
import mhealthapp.Device.TypeDevice;

import java.util.ArrayList;
import java.util.Hashtable;

public class ConnectFragment extends Fragment implements ScreenShotable {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageButton connectButton = (ImageButton) mLinearLayout.findViewById(R.id.imageBut);
        connectButton.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                System.out.println("用户添加点击");
            ...
            case REQUEST_ENABLE_BT:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Intent serverIntent = new Intent(getActivity().getApplicationContext(),
                            mhealthapp.DeviceListActivity.class);

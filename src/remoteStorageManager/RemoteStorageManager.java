...
public class RemoteStorageManager {
    ...
    public RemoteStorageManager() {
        ...
        //Scripts paths
        mobileUnitsPath = "insert_mobile_units";
        shimmerUnitsPath = "insert_shimmer_units";
        mobileSignalsPath = "insert_mobile_signals";
        shimmerSignalsPath = "insert_shimmer_signals";
        mobileMetadataPath = "insert_mobile_metadata";
        shimmerMetadataPath = "insert_shimmer_metadata";
        lastIDPath = "get_last_ID";
    }
                    ...
                    switch (msg.what) {
                        ...
                        case 3: // Mobile&Shimmer Metadata Table
							...
							*/
                                ...
                                // To log the result using JSON
                                String jsonResult = Utilities.inputStreamToString(httpResponse2.getEntity().getContent()).toString();

...
import dataprocessingManager.acquisition.Acquisition;
...
public class DataProcessingManager extends Service {
    ...
    private DataProcessingManager() {
        ...
        hash = null;
        inferenceOnDevices = new Hashtable<String, ObjectProcessing>();
        seconds = 0;
        inferenceOnDevices = new Hashtable<String, ObjectProcessing>();
        buffersReady = 0;
    ...
    class ObjectProcessing {
        ...
        public ObjectProcessing(String nameDevice,
            ...
            hashOnline = new Hashtable<SensorType, ArrayList<Double>>();
        }
    ...
    public void retrieveByLogin(String loginName, ArrayList<Pair<ArrayList<SensorType>, String>> sensorsAndDevices) {
        hash = acquisition.retrieveInformationByLogin(loginName, sensorsAndDevices);
        logAcquiredData();
    ...
    public void retrieveInformationByLastID(
            String nameMetaTable, ArrayList<Pair<ArrayList<SensorType>, String>> sensorsAndDevices) {
        hash = acquisition.retrieveInformationByLastID(nameMetaTable, sensorsAndDevices);
        logAcquiredData();
    ...
    public double[] classifyInstanceToFM(Instance unlabeled) {
        return classification.classifyInstanceToFM(unlabeled);
    }

...
public class Storage {
	...
	public void insertMobileMetadata(ObjectMetadata metadata, String nameTable) {
		...
		dbadapter.insertMobileMetadata(array, nameTable, format, metadata.startToString(), metadata.finishToString(), metadata.rate, metadata.login);
	}
	...
	public Pair<Integer, Integer> getLoginNameIDs(String nameTable, String loginName) {
		...
		return dbadapter.getLoginNameIds(nameTable, loginName);
	}
	/**

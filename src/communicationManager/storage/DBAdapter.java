...
public class DBAdapter {
	...
	public void createMobileTableMetadata(String nameMetadata) {
		...
		String sql = "create table if not exists " + nameMetadata + " (" + ID
				...
				+ " text," + FIRST_INDEX + " integer," + LAST_INDEX
				+ " integer," + RATE + " integer," + LOGIN +" text "+");";
	 ...
	 * @param rate session rate
	 */
	public void insertMobileMetadata(int[] array, String nameTable,	String format, String start, String finish, double rate,String login) {
	...
	public Pair<Integer, Integer> getLoginNameIds(String nameTable, String loginName) {

		String sql = "select " + FIRST_INDEX + ", " + LAST_INDEX + " from " + nameTable + " where " + LOGIN + "=" +"'"+ loginName+"'"+ ";";
	...
	/*
	public Hashtable<SensorType, ArrayList<Double>> retrieveInformationLastID(String nameTable, ArrayList<SensorType> sensors) {
		int maxId = getMaxIndex(nameTable);
		String sql = "select " + TIME_STAMP + " from " + nameTable + " where " + ID + "=" + maxId + ";";
		Cursor c = db.rawQuery(sql, null);
		c.moveToFirst();
